...
class FrontendProductController extends Controller
{
    public function productsIndex(Request $request)
    {
        if ($request->has('subcategorySlug')) {
            $subcategory = SubCategory::where('slug', $request->subcategorySlug)->firstOrFail();
        ...
        return view('frontend.pages.product-list', compact('products', 'categories', 'brands', 'productpage_banner_section'));
    }
