...
use App\Http\Controllers\Frontend\Cartpage;
use App\Http\Controllers\Frontend\ListPage;
use App\Http\Controllers\Frontend\DetailPage;
use App\Http\Controllers\Frontend\CheckoutPage;
use App\Http\Controllers\Frontend\MenDashboard;
use App\Http\Controllers\Frontend\KidsDashboard;
use App\Http\Controllers\Backend\AdminController;
use App\Http\Controllers\Frontend\BlogController;
use App\Http\Controllers\Frontend\CartController;
use App\Http\Controllers\Frontend\HomeController;
use App\Http\Controllers\Frontend\PageController;
use App\Http\Controllers\Frontend\WomenDashboard;
...
use App\Http\Controllers\Frontend\MenDashboardController;
use App\Http\Controllers\Frontend\NewDashboardController;
use App\Http\Controllers\Frontend\ProductTrackController;
use App\Http\Controllers\Frontend\KidsDashboardController;
use App\Http\Controllers\Frontend\UserDashboardController;
use App\Http\Controllers\Frontend\WomenDashboardController;
use App\Http\Controllers\Frontend\FrontendProductController;
use App\Http\Controllers\Frontend\SeasonDashboardController;
...
Route::get('cart-details', [CartController::class, 'cartDetails'])->name('cart-page');
...
// Route::put('/update-cart/{id}',[ CartController::class,'update'])->name('cart.update');

// Route::post('/cart/remove', 'CartController@remove')->name('frontend.cart.remove');
...
Route::get('/Men-dashboard', [MenDashboardController::class, 'menindex'])->name('Men-dashboard');
Route::get('/women-dashboard', [WomenDashboardController::class, 'index'])->name('women-dashboard');
Route::get('/kids-dashboard', [KidsDashboardController::class, 'index'])->name('kids-dashboard');
Route::get('/New-dashboard', [NewDashboardController::class, 'index'])->name('New-dashboard');
Route::get('/Season-dashboard', [SeasonDashboardController::class, 'index'])->name('Season-dashboard');
