...
<head>
    @section('title')
    {{$settings->site_name}} | Women Product
    @endsection
		...
		<section class="main-banner">
			<div class="">
                ...
                <a href="{{$homepage_secion_banner_three->banner_two->banner_url}}">
                    <img class="img-gluid" src="{{asset($homepage_secion_banner_three->banner_two->banner_image)}}" alt="" style="width:100%">
                </a>
            @endif
			</div>
		</section>
		<section class="cat-outer-section">
			<div class="container">
				<div class="row">
                    ...
                    @foreach($womenSubCategories as $item)
