...
<head>
    @section('title')
    {{$settings->site_name}} | Season Product
    @endsection
...
<body>
   ...
   <div class="main-body">
    <section class="main-banner">
        <div class="">
            <img src="{{ asset('frontend/uthr/assets/img/headerIcons/Season.jpg') }}" alt="kids banner" style="width: 100%">
        </div>
    </section>
    ...
    <section class="cat-outer-section">
        <div class="container">
            <div class="row">
                @foreach( $SeasonSubCategories as $item)
