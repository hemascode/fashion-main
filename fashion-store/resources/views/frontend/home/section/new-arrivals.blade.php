<section class="product_section ">
    ...
    <h2>Our Collections</h2>
        <p style="margin-bottom: 30px">Check out most promising product bought by our buyers</p></center>
     </div>
    ...
    <div class=" product_slick slick_slider_activation" data-slick='{
        ...
        <div class="col-sm-6 col-md-4 col-lg-3">
            <article class="single_product">
             ...
             <div class="product-category float-left">Kids</div>
                        ...
                        <h4 class="product_name"><a href="/product-list">Basic Joggin Shorts</a></h4>
        ...
        <div class="col-sm-6 col-md-4 col-lg-3">
            ...
            <a href="/product-list" >                                        <img class="primary_img" src="https://i.pinimg.com/originals/7e/09/05/7e0905f16f494b084c4e9ccac4ed521d.jpg" alt="consectetur">
                    ...
                    <figcaption class="product_content text-center">
                        ...
                        <h4 class="product_name"><a href="/product-list">Make Thing Happen T-Shirts</a></h4>
                        <div class=" price_box text-left">
        ...
        <div class="col-sm-6 col-md-4 col-lg-3">
            <article class="single_product">
                <figure>
                    <div class="product_thumb">
             <a href="/product-list" ><img class="primary_img" src="https://i.ezbuy.sg/Fr42grQtOhrTMEKt4gzucPtv3RLt" alt="consectetur">
                        </a>
                        <div class="product_action">
                            <ul>
                                <li class="wishlist"><a href="#" data-tippy="Wishlist" data-tippy-inertia="true" data-tippy-delay="50"
            ...
            <div class="product-category float-left">Kids</div>
                        ...
                        <h4 class="product_name"><a href="/product-list">Basic White Simple Sneaker</a></h4>
                        <div class=" price_box text-left">
        ...
        <div class="col-sm-6 col-md-4 col-lg-3">
            <article class="single_product">
                <figure>
                    <div class="product_thumb">
              <a href="/product-list" >                                        <img class="primary_img" src="https://www.twinset.com/on/demandware.static/-/Sites-master-catalog/default/dw1f70a43b/images/TwinSet/Images/Catalog/999TZ4013-00006-0T.JPG" alt="consectetur">
                        </a>
                        <div class="product_action">
                            <ul>
                                <li class="wishlist"><a href="#" data-tippy="Wishlist" data-tippy-inertia="true" data-tippy-delay="50"
        ...
        <div class="product-category float-left">Kids</div>
                        ...
                        <h4 class="product_name"><a href="/product-list">Simple Rounded Sunglasses</a></h4>
                        <div class=" price_box text-left">
        ...
        <div class="col-sm-6 col-md-4 col-lg-3">
         ...
         <a href="/product-list" >                                        
            ...
            <img class="primary_img" src="https://cdn-img.prettylittlething.com/a/1/7/4/a1740e7f3456acb467687303f2babd5558545847_cma3859_1.jpg" alt="consectetur">
                        </a>
                        <div class="product_action">
                            <ul>
                                <li class="wishlist"><a href="#" data-tippy="Wishlist" data-tippy-inertia="true" data-tippy-delay="50"
