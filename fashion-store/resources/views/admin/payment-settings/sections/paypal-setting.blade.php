        ...
        <form action="{{route('admin.paypal-setting.update', 1)}}" method="POST">
            ...
            <div class="form-group">
                ...
                <select name="status" id="" class="form-control">
                    <option {{($paypalSetting && $paypalSetting->status === 1) ? 'selected' : ''}} value="1">Enable</option>
                    <option {{($paypalSetting && $paypalSetting->status === 0) ? 'selected' : ''}} value="0">Disable</option>
                </select>
            ...
            <div class="form-group">
                ...
                <select name="mode" id="" class="form-control">
                    <option {{($paypalSetting && $paypalSetting->mode === 1) ? 'selected' : ''}} value="0">Sandbox</option>
                    <option {{($paypalSetting && $paypalSetting->mode === 0) ? 'selected' : ''}} value="1">Live</option>
                </select>
            </div>
